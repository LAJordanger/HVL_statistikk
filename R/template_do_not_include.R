## #####  2017-08-20: This messy stuff has been copied from the
## #####  localgaussSpec-package in order to provide a template for the
## #####  interface functions to be used in the HVLstatistikk-package.
